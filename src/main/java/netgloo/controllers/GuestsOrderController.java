			...
			*/
			...
			if(emp.getEmployeeRole().equals("Bartender"))
			{
				...
				for(OrderedBeverage ob : listac)
				{
					...
					OrderImmitation oi = new OrderImmitation(ob.getOrderedBeverageID(),ob.getBeverage().getBeveragesName(),ob.getQuantity(),note,acceptedTime,doneTime,employeeString,ob.getGuestsOrder().getDiningTable().getTableNumberInRestaurant());
			...
			if(emp.getEmployeeRole().equals("Cook"))
			{
				...
				for(OrderedMeal ob : listac)
				{
					...
					OrderImmitation oi = new OrderImmitation(ob.getOrderedMealID(),ob.getMenu().getMenuMealDescription(),ob.getQuantity(),note,acceptedTime,doneTime,employeeString,ob.getGuestsOrder().getDiningTable().getTableNumberInRestaurant());
					orderImitsList.add(oi);
				}
			}
